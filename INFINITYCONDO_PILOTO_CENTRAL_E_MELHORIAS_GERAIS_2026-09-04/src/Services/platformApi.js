...
const platformApi = {
  ...
  condominiums: {
    ...
    async changePlan(id, payload) {
      return dataOf(await api.patch(`/v1/platform/condominiums/${id}/plan`, payload));
    },

    async lifecycle(id, payload) {
      return dataOf(await api.patch(`/v1/platform/condominiums/${id}/lifecycle`, payload));
    },
  },
  ...
  supportTickets: {
    async list(params = "") { return dataOf(await api.get(`/v1/platform/support-tickets${params}`)); },
    async update(id, payload) { return dataOf(await api.patch(`/v1/platform/support-tickets/${id}`, payload)); },
  },
  ...
  operations: {
    ...
    async databaseOverview() { return dataOf(await api.get("/v1/platform/operations/database/overview")); },
    async resetHomologation(confirmation) { return dataOf(await api.post("/v1/platform/operations/database/reset-homologation", { confirmation })); },
  },

  finance: {
    async allCharges(params = "") { return listOf(await api.get(`/v1/platform/charges${params}`)); },
