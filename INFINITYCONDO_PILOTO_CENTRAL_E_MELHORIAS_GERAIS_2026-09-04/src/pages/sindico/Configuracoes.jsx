    ...
    <div style={styles.container}>
            ...
            <Campo label="Cor principal">
              ...
              >
                ...
                <div style={styles.colorPreviewBody}>
                  ...
                  <span>
                    Preferência visual do condomínio.
                  </span>
                </div>
              </div>
            </Campo>
      ...
      {abaAtiva === "seguranca" && (
        <section style={styles.panel}>
          ...
          <div style={styles.formGrid}>
            ...
            <Campo label="Renovação automática de sessão">
              <select
      ...
      {abaAtiva === "whatsapp" && (
        <section style={styles.panel}>
          <div style={styles.panelHeader}>
            <div>
              <span style={styles.panelBadgeGold}>WhatsApp Business</span>
          ...
          <div style={styles.warningBox}>
            Configure os dados do WhatsApp Business. O envio utiliza as credenciais do ambiente e é registrado pela plataforma.
          </div>
        ...
        <section style={styles.panel}>
          ...
          <div style={styles.preferenceGrid}>
            ...
            <ToggleCard
              ...
              description="Mantém rotinas automáticas de proteção dos dados."
