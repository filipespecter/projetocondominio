...
import PlatformDashboardExecutive from "./pages/platform/PlatformDashboardExecutive";
...
import PlatformFinanceExecutive from "./pages/platform/PlatformFinanceExecutive";
...
import PlatformSupportDesk from "./pages/platform/PlatformSupportDesk";
import PlatformOperations from "./pages/platform/PlatformOperations";
import PlatformDatabase from "./pages/platform/PlatformDatabase";
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          <Route
            index
            element={<PlatformDashboardExecutive />}
          />
          ...
          <Route
            path="financeiro"
            element={<PlatformFinanceExecutive />}
          />
