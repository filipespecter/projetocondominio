...
import platformSupportTicketRoutes from "./platform-support-ticket.routes.js";
...
// Suporte permanece acessível mesmo quando a assinatura estiver suspensa.
...
router.use("/v1/search", ...operationalGuards, searchRoutes);
