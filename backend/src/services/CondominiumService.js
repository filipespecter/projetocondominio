...
class CondominiumService extends BaseService {
  ...
  /**
   * Lista simples mantida para compatibilidade.
   *
   * A listagem administrativa com filtros e
   * paginação fica no PlatformCondominiumService.
   */
  async findAll() {
   ...
   * Criação genérica.
   *
   * O estado padrão atual é PENDING.
   */
  async create(
    data,
  ...
  async activate(
    ...
    const updated =
      await condominiumRepository.activate(
        id
      );
  ...
  async suspend(
    ...
    const updated =
      await condominiumRepository.suspend(
        id
      );
  ...
  async cancel(
    ...
    const updated =
      await condominiumRepository.cancel(
        id
      );
