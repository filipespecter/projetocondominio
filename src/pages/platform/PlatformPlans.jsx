...
const styles={grid:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(320px,1fr))",gap:18},card:{position:"relative",padding:26,borderRadius:28,background:"linear-gradient(145deg,#fff,#faf7ff)",border:"1px solid var(--ic-primary-soft-2)",boxShadow:"0 18px 50px rgb(var(--ic-primary-deep-rgb) / .10)",overflow:"hidden"},complete:{background:"radial-gradient(circle at top right,rgb(var(--ic-primary-bright-rgb) / .18),transparent 32%),linear-gradient(145deg,#fff,#f7f0ff)",border:"1px solid var(--ic-primary-border)",boxShadow:"0 24px 65px rgb(var(--ic-primary-dark-rgb) / .18)"},ribbon:{position:"absolute",right:18,top:18,padding:"7px 11px",borderRadius:999,background:"linear-gradient(135deg,var(--ic-primary-strong),var(--ic-primary-bright))",color:"white",fontSize:10,fontWeight:900,letterSpacing:1},top:{display:"flex",justifyContent:"space-between",gap:14,alignItems:"flex-start"},code:{fontSize:10,fontWeight:900,letterSpacing:1.5,color:"var(--ic-primary)"},title:{fontSize:27,margin:"6px 0",color:"#24113c"},desc:{color:"#6b7280",lineHeight:1.5,maxWidth:520},status:{padding:"7px 10px",borderRadius:999,fontSize:10,fontWeight:900},price:{display:"flex",alignItems:"baseline",gap:7,margin:"22px 0",paddingBottom:20,borderBottom:"1px solid var(--ic-primary-soft-2)"},section:{display:"grid",gap:10,marginBottom:20},feature:{display:"flex",alignItems:"flex-start",gap:10,padding:"10px 0"},check:{width:24,height:24,borderRadius:8,background:"var(--ic-primary-soft-2)",color:"var(--ic-primary-strong)",display:"grid",placeItems:"center",fontWeight:900},lock:{width:24},baseText:{padding:14,borderRadius:14,background:"#faf7ff",color:"#5b4b67",lineHeight:1.55},actions:{display:"grid",gap:14},clientBox:{display:"grid",gap:9,padding:14,borderRadius:16,background:"#faf7ff",border:"1px solid var(--ic-primary-soft-2)"},clientHelp:{color:"#6b7280",lineHeight:1.45},select:{width:"100%",minHeight:42,borderRadius:12,border:"1px solid var(--ic-primary-border-soft)",background:"#fff",padding:"0 12px",color:"#24113c"},success:{marginBottom:16,padding:"12px 14px",borderRadius:14,background:"#ecfdf5",border:"1px solid #bbf7d0",color:"#166534",fontWeight:700},note:{marginBottom:0,color:"#6b7280",lineHeight:1.6}};
