...
const styles = {
  ...
  hero: {
    ...
    gap: "30px",
    marginBottom: "26px",
    boxShadow: "0 22px 55px rgb(var(--ic-primary-rgb) / 0.24), 0 0 38px rgb(var(--ic-primary-bright-rgb) / 0.12)",
  ...
  submitButton: {
    ...
    cursor: "pointer",
    fontWeight: "800",
    boxShadow: "0 12px 25px rgb(var(--ic-primary-rgb) / 0.20)"
  },
  ...
  timelineDot: {
    ...
    marginTop: "26px",
    boxShadow: "0 0 0 6px var(--ic-primary-soft)"
  },
